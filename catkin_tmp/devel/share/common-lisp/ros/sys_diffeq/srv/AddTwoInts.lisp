...
(cl:defmethod cl:initialize-instance :after ((m <AddTwoInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddTwoInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sys_diffeq-srv:<AddTwoInts-request> is deprecated: use sys_diffeq-srv:AddTwoInts-request instead.")))

(cl:ensure-generic-function 'x_new-val :lambda-list '(m))
(cl:defmethod x_new-val ((m <AddTwoInts-request>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <AddTwoInts-request>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'x_new)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AddTwoInts-request>) istream)
  "Deserializes a message object of type '<AddTwoInts-request>"
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'x_new) (cl:if (cl:< unsigned 9223372036854775808) unsigned (cl:- unsigned 18446744073709551616))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AddTwoInts-request>)))
  ...
  "2a4f2be7eea4eed058244c2783c6c637")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AddTwoInts-request)))
  "Returns md5sum for a message object of type 'AddTwoInts-request"
  "2a4f2be7eea4eed058244c2783c6c637")
...
(cl:defmethod cl:initialize-instance :after ((m <AddTwoInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddTwoInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sys_diffeq-srv:<AddTwoInts-response> is deprecated: use sys_diffeq-srv:AddTwoInts-response instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <AddTwoInts-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sys_diffeq-srv:x-val is deprecated.  Use sys_diffeq-srv:x instead.")
  (x m))
